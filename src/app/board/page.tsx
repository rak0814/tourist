...
export default async function BoardPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <Link
        href="/board/write"
        className="absolute right-4 z-10 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-white shadow-lg active:scale-95 transition-transform"
