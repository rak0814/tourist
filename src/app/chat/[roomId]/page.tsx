        ...
        return (
          <>
            ...
            >
              ...
              <button onClick={closeMenu} className="flex w-full items-center gap-2 border-t border-zinc-100 px-4 py-3 text-sm active:bg-zinc-100 dark:border-zinc-700 dark:active:bg-zinc-700">
              ...
              <button onClick={closeMenu} className="flex w-full items-center gap-2 border-t border-zinc-100 px-4 py-3 text-sm text-red-500 active:bg-zinc-100 dark:border-zinc-700 dark:active:bg-zinc-700">
