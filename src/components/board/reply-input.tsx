  ...
  return (
    <div className="ml-8 flex items-center gap-2 border-l border-zinc-100 py-2 pl-3 dark:border-zinc-800">
      ...
      <button
        ...
        className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white disabled:bg-zinc-200 disabled:text-zinc-400 dark:disabled:bg-zinc-800"
      >
